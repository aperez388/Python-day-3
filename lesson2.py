#create a print function that prints out the string "Hello, World!"
# print("Hello, World!")
...
# year = "2024" #if it is wrapped in a string it is a string variable
# python thinks this is a word
...
listOfMovies = ["The Crow", "Deadpool", "BeetleJuice BeetleJuice", "The Lion King"]
...
dinnerPrice = 15.99
#check to see if the movie is playing in the evening or not
inEvening = True
# how many people are going
peopleGoing = input("How many people are going?  ")
# type conversion converting from one type of data type to another
# print the entire output in one sentence
print("We are going to see "+ movieName + " at " + movieTime + " and then eat dinner at " + restaurantAddress + " at " + dinnerTime + " with " + peopleGoing + " people.")
# in order for print function to work you need all of it to be a string. only use int() in other contexts
